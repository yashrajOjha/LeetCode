class Solution {
    public int func(int r1, int c1, int r2, int grid[][], int dp[][][]){
        int c2 = r1+c1-r2;
        ...
        int vv = func(r1+1,c1,r2+1,grid,dp);
        int hh = func(r1, c1+1,r2,grid,dp);
        int vh = func(r1+1,c1,r2,grid,dp);
        int hv = func(r1, c1+1,r2+1,grid,dp);
    ...
    public int cherryPickup(int[][] grid) {
        ...
        return Math.max(func(0,0,0,grid,dp),0);
    }
}